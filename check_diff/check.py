...
from pp.model import ProjectionNet as net_pp
from t.model import ProjectionNet as net_torch
...
def check_backward(model_pp,model_torch,optim_pp,optim_torch,scheduler_pp,scheduler_torch,loss_pp,loss_torch,loader_pp,loader_torch):
    """
    检查反向传播过程
    """
...
if __name__ == '__main__':
    ...
    check_backward(model_pp, model_torch, optim_pp, optim_torch, scheduler_pp, scheduler_torch,loss_pp,loss_torch,loader_pp,loader_torch)
    pass